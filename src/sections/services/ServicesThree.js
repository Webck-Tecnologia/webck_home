                                ...
                                <AnimationContainer animation="fadeInDown"  delay={400}>
                                    <ServiceElement>
                                        ...
                                        <ServiceList>
                                            ...
                                            <ServiceListElement>
                                                Hospedagem de aplicações Web servidores de alta velocidade
                                            </ServiceListElement>
                                            <ServiceListElement>
                            ...
                            <Col md={4}>
                                <AnimationContainer animation="fadeInRight" delay={600}>
                                    <ServiceElement>
                                        ...
                                        <ServiceList>
                                            <ServiceListElement>
                                                SEO (Search Engine Optimization) - Apareça na busca Orgânica do Google
                                            </ServiceListElement>
                                            <ServiceListElement>
                                                SEM - Gestão de Impulsionamentos Pagos
                                            </ServiceListElement>
                                            <ServiceListElement>
                                                Criação e Execução de Plano Estratégico de Marketing
                                            </ServiceListElement>
                                        </ServiceList>
                                    </ServiceElement>
                                </AnimationContainer>
                            ...
                            <Col md={4}>
                                <AnimationContainer animation="fadeInLeft" delay={800}>
                                    <ServiceElement>
                                        ...
                                        <ServiceList>
                                            <ServiceListElement>
                                                Análise e Reparo de Brechas na Segurança Tecnológica
                                            </ServiceListElement>
                                            <ServiceListElement>
                                                Análise e Adequação dos Processos Interno às Exigências da LGPD
                                            </ServiceListElement>
                                            <ServiceListElement>
                                    ...
                                    <AnimationContainer animation="fadeInRight" delay={1200}>
                                        <ServiceElement>
                                            ...
                                            <ServiceList>
                                                ...
                                                <ServiceListElement>
                                                    Ferramentar de Comunicação com Clientes
                                                </ServiceListElement>
                                            </ServiceList>
                                        </ServiceElement>
                                    </AnimationContainer>
