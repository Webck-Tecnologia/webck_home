                    ...
                    <Row>
                        ...
                        <Col md={6}>
                            <AnimationContainer animation="fadeIn">
                                ...
                                <Separator />
                                <Text>
                                   Somos uma empresa inovadora focada em desenvolvimento de soluções tecnológicas na resolução de problemas nos seguintes campos: Desenvolvimento de Sistemas Web e Mobile, Segurança da 
                                   informação, Compliance e Marketing estratégico. Esses quatro pilares surgiram
                                   para atender as demandas de empresários como <b>você</b>, que buscam ajuda na resolução de dificuldades do dia a dia.
                                </Text>
                                <TabsPart />
                            </AnimationContainer>
                        </Col>
                        ...
                        <Row>
                            <Col md={3}>
                                <AnimationContainer animation="fadeIn" delay={1000}>
                                    <CounterComponent>
                                        <Counter value={5} duration={5} delay={1000} symbol="+" text="5 Anos de Experiência" animation={true} />
                                    </CounterComponent>
                                </AnimationContainer>
                            </Col>
                            <Col md={3}>
                                <AnimationContainer animation="fadeIn" delay={1000}>
                                    <CounterComponent>
                                        <Counter value={100} duration={5} delay={1000} symbol="+" text="Clientes satisfeitos" animation={true} />
                                    </CounterComponent>
                                </AnimationContainer>
                            </Col>
                            <Col md={3}>
                                <AnimationContainer animation="fadeIn" delay={1000}>
                                    <CounterComponent>
                                        <Counter value={100} duration={5} delay={1000} symbol="+" text="Avaliações Positivas" animation={true} />
                                    </CounterComponent>
                                </AnimationContainer>
                            </Col>
                            <Col md={3}>
                                <AnimationContainer animation="fadeIn" delay={1000}>
                                    <CounterComponent>
                                        <Counter value={10} duration={5} delay={1000} symbol="+" text="Parceiros" animation={true} />
                                    </CounterComponent>
                                </AnimationContainer>
                            </Col>
                        </Row>
